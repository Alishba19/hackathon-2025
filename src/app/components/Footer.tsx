...
const Footer = () => { 
  return(
    <div className="w-[632px] h-[230px] flex pt-[10%] bg-[#fafafa]">
        <div>
        <h2 className="h-[24px] w-[130px] text-[12px] mt-5 mb-2 ml-5 font-inter text-[#000000] 3% ">Company Info</h2>
        <h2 className="w-[87px] h-[24px] font-poppins ml-5 font-[500] text-[9px] text-[#000000]">About Us</h2>
        <p className="font-poppins text-[9px] font-normal ml-5 w-[50px] text-[#000000] h-[24px]">carrier</p>
        <p className="font-poppins text-[9px] font-normal ml-5  w-[97px] text-[#000000] h-[24px]">We are hiring</p>
        <p className="font-poppins text-[9px] font-normal ml-5 w-[33px] text-[#000000] h-[24px]">Blog</p>
        </div>
        <div>
            <h2 className="w-[45px] h-[24px] mt-5 mb-2 font-poppins text-[12px] text-[#000000] ">Legal</h2>
        ...
        <div>
        <h2 className="w-[72px] h-[24px] mt-5 mb-2 font-poppins text-[12px] text-[#000000] ">Features</h2>
        ...
        <div>
        <h2 className="w-[86px] h-[24px] mt-5 mb-2 font-poppins text-[12px] text-[#000000] ">Resources</h2>
        ...
        <div>
        <h2 className="w-[150px] h-[25px] mt-5 mb-2 font-poppins text-[12px] text-[#000000] ">Get In Touch</h2>
