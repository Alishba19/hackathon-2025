...
const Product = () => {
  return (
    <div className="grid grid-cols-1 bg-slate-100 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-5 px-0 md:px-0 lg:px-12 py-8  space-y-3 md:space-y-4 lg:space-y-0">
