...
const Products = () => {
  ...
  return (
    <section className="w-full h-auto bg-slate-100 mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-7 gap-y-14 sm:gap-y-9">
          {products.map((product) => (
            ...
            >
              ...
              />
              {/* Product Info */}
              <p className="text-[1rem] font-semibold text-black text-textColor">
                {product.name}
              </p>
              <p className="text-secondtextColor font-semibold text-black text-[0.875rem]">
                {product.department}
              </p>
              <div className="font-semibold text-black text-[1rem] space-x-3">
